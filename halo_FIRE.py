...
yt.add_field(("gas","HI_column_density"), function=_column_density, units="cm**-2", sampling_type='particle')
...
if __name__ == '__main__':
    ...
    for fn in yt.parallel_objects(fns):
        ...
        p = yt.PhasePlot(ad, ('PartType0', 'cylindrical_radius_kpc'), ('PartType0', 'velocity_cylindrical_z'), ('gas', 'HI_column_density'), weight_field=None)
